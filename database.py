...
def _seed_data(conn):
    ...
    items = [
        ...
        # Drinks
        ("Single Espresso",                   "",                                                                                          30.0,  "Drinks",           "/static/uploads/1122027b5d3647f6a509b28c7cb1dfa2.png", '["vegan","gluten_free"]',         "", 3, 1),
        ("Double Espresso",                   "",                                                                                          31.0,  "Drinks",           "/static/uploads/492be1c5bea344b4a0af558e760385e6.png", '["vegan","gluten_free"]',         "", 3, 2),
        ("Espresso Macchiato",                "",                                                                                          35.0,  "Drinks",           "/static/uploads/c629809064114c0d9e0b11b4887ccd7c.png", '["vegetarian","gluten_free"]',   "Dairy", 5, 3),
        ("Americano",                         "",                                                                                          31.0,  "Drinks",           "/static/uploads/5ec583ad1ea44316a9c556253c6bc6b1.png", '["vegan","gluten_free"]',         "", 5, 4),
        ("Cappuccino",                        "Oat Milk available on request.",                                                           42.0,  "Drinks",           "/static/uploads/3c109f26f3c24b8bafd491db84e368b6.png", '["vegetarian","gluten_free"]',   "Dairy", 5, 5),
        ("Decaf Cappuccino",                  "Oat milk available on request",                                                            42.0,  "Drinks",           "/static/uploads/61b9dfabfb8542cb8fac9910034e285a.png", '["vegetarian","gluten_free"]',   "Dairy", 5, 6),
        ("Flat White",                        "",                                                                                          42.0,  "Drinks",           "/static/uploads/44fab51226e345d3bd7551a60307daf1.png", '["vegetarian","gluten_free"]',   "Dairy", 5, 7),
        ("Caffe Latte",                       "",                                                                                          45.0,  "Drinks",           "/static/uploads/66f5b4df04c441d981e94b02c746fa4b.png", '["vegetarian","gluten_free"]',   "Dairy", 5, 8),
        ("Tea",                               "Rooibos, Camomile, Green & Ceylon",                                                        33.0,  "Drinks",           "/static/uploads/aff503819d2449b7a225563ed697cfb5.png", '["vegan","gluten_free"]',         "", 5, 9),
        ("Hot Chocolate",                     "",                                                                                          47.0,  "Drinks",           "/static/uploads/763d4b5aea4f4409ab8496b6915fdddd.png", '["vegetarian","gluten_free"]',   "Dairy", 5, 10),
